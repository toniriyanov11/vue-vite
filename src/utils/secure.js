...
const sec = import.meta.env.VITE_APP_SEC
...
function encryptString(plaintext, password=sec) {
...
function decryptString(base64CiphertextAndNonceAndSalt, password=sec) {
    // Decode the base64.
